 ...
 * 좌측 레일(`rail-detail-aside`)이 판정을 위로 올려 주지만 **모바일은 레일이 제목 카드
 * 뒤에야 온다.** #909 가 레일을 기본 정보 앞으로 올려 390 에서 판정 카드가 첫 화면 끝(629)에
 * 걸리게 됐지만, 사진이 첫 화면 절반을 먹어 답 자체는 여전히 접힘 아래다 — 요약은 그대로 둔다.
 *
