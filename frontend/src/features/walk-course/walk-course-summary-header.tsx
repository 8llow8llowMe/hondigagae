      ...
      */}
      <header className={cn('flex flex-col gap-3 py-4 md:py-5', INSET_CLASS.card)}>
        ...
        {/*
          ...
          **`<dl>` 밖이다** (D5-4 ② · D6). `<dl>` 은 고정 2열이라 셋째 칸이 반 칸을 비운 채
          ...
          **자리는 `<dl>` 아래, 시종점 위다** (D5-4 ④). 거리·소요시간·활동량은 *이 코스가
