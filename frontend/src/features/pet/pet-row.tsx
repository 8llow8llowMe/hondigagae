 ...
 *
 * 아바타는 이름 첫 글자다 — 백엔드 `PetSaveRequest` 에 사진 필드가 없다
 * (목록-세부명세 D8-1). 사진 폴백 순서(업로드 → 견종 일러스트 → 이니셜)의 마지막 단계다.
 *
    ...
    <Row as="li" last={last}>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span
            aria-hidden="true"
            className="bg-band text-fg text-title-2 flex size-12 shrink-0 items-center justify-center rounded-full font-bold"
          >
            {pet.name.slice(0, 1)}
          </span>
