 ...
 *  - AI 일정 생성: 데스크톱 nav 에만. 진입 빈도가 낮고 일정 화면 안에서 시작하는 것이 맥락에
 *    맞다. 모바일 진입점은 홈의 배너와 `/plans` 의 시트다 (#905 R1)
 ...
 * 애초에 없다 — 근거는 명세 D4-2. (홈의 AI 배너는 #905 R1 이 뒤에 더한 것이고, 그 배너도
 * 같은 이유로 게스트에게 이 함수를 거쳐 로그인으로 보낸다.)
 */
