...
| plan    | `공통명세.md`, `일정상세-세부명세.md`, `일자편집-세부명세.md`                                                   | 작성 중                                       | 구현                 | 목록·생성 구현 완료 (#75) / 상세·편집 명세 완료·구현 미착수      |
...
| plan    | 날씨 `skyState`·`precipitationType` 이 metadata 객체 | **`skyStateName`·`precipitationTypeName` 문자열**                        |
