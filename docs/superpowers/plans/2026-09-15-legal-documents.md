      ...
      blocks: [
        {
          ...
          rows: [
            ...
            ['반려견 프로필', '반려견 이름, 견종, 출생 연월, 크기, 체중, 활동량, 산책 선호도, 사회성, 환경 민감도, 사진', '회원 직접 입력'],
      ...
      blocks: [
        {
          ...
          rows: [
            ...
            ['접속 기록', '3개월 (통신비밀보호법)'],
            ['탈퇴 회원의 이메일 (재가입 제한 목적)', '별도의 삭제 시점을 두지 않음'],
            ['위치정보', '보유하지 않음'],
          ],
        },
        {
          kind: 'text',
          text: '탈퇴 시 이름과 닉네임은 마스킹하고 비밀번호와 프로필 이미지는 삭제합니다. 이메일은 같은 계정이 다시 가입하는지 판정하는 목적으로만 보관하며, 그 밖의 용도로 이용하지 않습니다.',
        },
      ],
    },
    {
