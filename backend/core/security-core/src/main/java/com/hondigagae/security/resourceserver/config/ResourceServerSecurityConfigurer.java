...
import com.hondigagae.security.resourceserver.handler.OAuth2AuthenticationFailureHandler;
import com.hondigagae.security.resourceserver.jwt.JwtResourceServerProperties;
import com.hondigagae.security.resourceserver.jwt.JwtToMemberConverter;
import com.hondigagae.security.resourceserver.resolver.OAuth2ResourceTokenErrorResolver;
...
public class ResourceServerSecurityConfigurer {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtToMemberConverter jwtToMemberConverter,
