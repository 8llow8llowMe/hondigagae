 ...
 *
 * <p><b>그 214 는 시설 수가 아니라 (이름, 주소) 표기 쌍의 개수다</b> (#569). 이름의 공백 한 칸만
 * 달라도 해시가 갈려 같은 시설이 두 행으로 남았고, dev 목록에 같은 동물병원이 두 번 떴다.
 * 그래서 batch 가 적재 직전에 (종류, 이름, 전화, 1km)로 한 번 더 접는다
 * ({@code EmergencyFacilityDeduplicator}). 접은 뒤 제주는 <b>213곳</b>이다.
 */
@Entity
@Getter
@Builder
