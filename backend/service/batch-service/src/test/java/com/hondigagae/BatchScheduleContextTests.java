 ...
 * 뜨고, JobDetail 2개와 트리거 2개가 실제 {@code Scheduler} 에 등록되는지 본다.
 *
 ...
 * 대신 <b>발화는 절대 일어나면 안 되므로</b> 두 cron 의 연도를 오지 않을 해로 못박는다. 실제
 * cron(월 03:00 / 매일 06:00) 해석은 {@code QuartzScheduleRegistrationTest} 가 본다.
 */
...
class BatchScheduleContextTests {
    ...
    void registersPipelineAndCongestionSchedules() throws Exception {
        ...
        for (String jobName : new String[]{"placeDataPipelineJob", "congestionImportJob"}) {
