 ...
 *
 * <p><b>그 214 로는 부족하다</b> (#569). {@code sourceKey} 는 *(이름, 주소) 표기*의 해시라 이름의
 * 공백 한 칸만 달라도 갈린다. 표기 차이까지 접는 일은
 * {@link EmergencyFacilityDeduplicator} 가 적재 직전에 한다 — 접은 뒤 제주는 213곳이다.
 *
