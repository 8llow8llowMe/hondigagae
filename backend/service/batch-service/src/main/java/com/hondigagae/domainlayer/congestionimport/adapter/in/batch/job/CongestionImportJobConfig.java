 ...
 *
 * <p>30일 rolling 원천이라 <b>일 1회 주기 실행</b>이 전제다. 같은 파라미터로 재실행하려면
 * run.id 같은 증분 파라미터를 추가하거나 기존 JobInstance 를 정리한다.
 */
@Configuration
public class CongestionImportJobConfig {
    ...
    public Step congestionImportStep(
        ...
        return new StepBuilder(STEP_NAME, jobRepository)
            .tasklet(congestionImportTasklet, transactionManager)
            .build();
    }
}
